...
// https://stackoverflow.com/questions/32412233/how-do-i-pass-session-to-ckfinder-in-codeigniter-3
$config['authentication'] = function () {
    $session_id = $_COOKIE['ci_session'];
    $content = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/../writable/session/ci_session' . $session_id);
    session_start();
